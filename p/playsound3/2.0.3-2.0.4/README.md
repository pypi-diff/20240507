# Comparing `tmp/playsound3-2.0.3.tar.gz` & `tmp/playsound3-2.0.4.tar.gz`
...
### Comparing `playsound3-2.0.3/playsound3.egg-info/PKG-INFO` & `playsound3-2.0.4/playsound3.egg-info/PKG-INFO`
