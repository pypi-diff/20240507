# Comparing `tmp/pygenuz-0.1.5.tar.gz` & `tmp/pygenuz-0.1.6.tar.gz`
...
## Comparing `pygenuz-0.1.5.tar` & `pygenuz-0.1.6.tar`
...
### Comparing `pygenuz-0.1.5/pygenuz/app.py` & `pygenuz-0.1.6/pygenuz/app.py`

 * *Files identical despite different names*

### Comparing `pygenuz-0.1.5/pygenuz/middelware.py` & `pygenuz-0.1.6/pygenuz/middelware.py`

 * *Files identical despite different names*

### Comparing `pygenuz-0.1.5/pygenuz/response.py` & `pygenuz-0.1.6/pygenuz/response.py`

 * *Files identical despite different names*

### Comparing `pygenuz-0.1.5/setup.py` & `pygenuz-0.1.6/setup.py`
