# Comparing `tmp/autogluon-1.1.1b20240505.tar.gz` & `tmp/autogluon-1.1.1b20240506.tar.gz`
...
## Comparing `autogluon-1.1.1b20240505.tar` & `autogluon-1.1.1b20240506.tar`
...
### Comparing `autogluon-1.1.1b20240505/PKG-INFO` & `autogluon-1.1.1b20240506/PKG-INFO`
...
### Comparing `autogluon-1.1.1b20240505/setup.py` & `autogluon-1.1.1b20240506/setup.py`

 * *Files identical despite different names*

### Comparing `autogluon-1.1.1b20240505/src/autogluon.egg-info/PKG-INFO` & `autogluon-1.1.1b20240506/src/autogluon.egg-info/PKG-INFO`
