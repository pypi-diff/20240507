# Comparing `tmp/vital-ai-vitalsigns-0.1.6.tar.gz` & `tmp/vital-ai-vitalsigns-0.1.7.tar.gz`
...
### Comparing `vital-ai-vitalsigns-0.1.6/LICENSE` & `vital-ai-vitalsigns-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/PKG-INFO` & `vital-ai-vitalsigns-0.1.7/PKG-INFO`
...
### Comparing `vital-ai-vitalsigns-0.1.6/setup.py` & `vital-ai-vitalsigns-0.1.7/setup.py`
...
### Comparing `vital-ai-vitalsigns-0.1.6/test/test_graph_collection.py` & `vital-ai-vitalsigns-0.1.7/test/test_graph_collection.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/test/test_query_builder.py` & `vital-ai-vitalsigns-0.1.7/test/test_query_builder.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/collection/graph_collection.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/collection/graph_collection.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/collection/rdf_collection_impl.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/collection/rdf_collection_impl.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/collection/vector_collection_impl.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/collection/vector_collection_impl.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/embedding/embedding_model.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/embedding/embedding_model.py`
...
### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/impl/vitalsigns_impl.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/impl/vitalsigns_impl.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/impl/vitalsigns_registry.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/impl/vitalsigns_registry.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/GraphObject.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/GraphObject.py`
...
### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/VITAL_Edge.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/VITAL_Edge.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/VITAL_GraphContainerObject.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/VITAL_GraphContainerObject.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/VITAL_HyperEdge.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/VITAL_HyperEdge.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/VITAL_HyperNode.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/VITAL_HyperNode.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/VITAL_Node.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/VITAL_Node.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/BooleanProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/BooleanProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/DateTimeProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/DateTimeProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/DoubleProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/DoubleProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/FloatProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/FloatProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/GeoLocationProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/GeoLocationProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/IProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/IProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/IntegerProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/IntegerProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/LongProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/LongProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/StringProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/StringProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/TruthProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/TruthProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/properties/URIProperty.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/properties/URIProperty.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/model/trait/PropertyTrait.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/model/trait/PropertyTrait.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/query/result_list.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/query/result_list.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/query/vital_graph_query.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/query/vital_graph_query.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/query/vital_query.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/query/vital_query.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/query/vital_select_query.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/query/vital_select_query.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns/vitalsigns.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns/vitalsigns.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns.egg-info/PKG-INFO` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns.egg-info/PKG-INFO`
...
### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns.egg-info/SOURCES.txt` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/AggregationResult.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/AggregationResult.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/DatabaseConnection.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/DatabaseConnection.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Dataset.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Dataset.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/DomainModel.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/DomainModel.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_SameAs.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_SameAs.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasApp.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasApp.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasAuthKey.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasAuthKey.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasChildCategory.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasChildCategory.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasChildDomainModel.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasChildDomainModel.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasDbConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasDbConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasIndexConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasIndexConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasOrganization.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasOrganization.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasParentDomainModel.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasParentDomainModel.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasProvisioning.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasProvisioning.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasSegment.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasSegment.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasSession.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasSession.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/Edge_hasTransaction.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/Edge_hasTransaction.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/GraphMatch.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/GraphMatch.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/RDFStatement.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/RDFStatement.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SparqlAskResponse.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SparqlAskResponse.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SparqlBinding.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SparqlBinding.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SparqlDatabaseConnection.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SparqlDatabaseConnection.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SparqlUpdateResponse.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SparqlUpdateResponse.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SqlDatabaseConnection.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SqlDatabaseConnection.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SqlResultRow.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SqlResultRow.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/SqlUpdateResponse.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/SqlUpdateResponse.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/URIReference.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/URIReference.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_Category.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_Category.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_Event.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_Event.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_GraphQuery.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_GraphQuery.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_PathQuery.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_PathQuery.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_PayloadNode.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_PayloadNode.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_PeerEdge.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_PeerEdge.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_Query.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_Query.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_SelectQuery.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_SelectQuery.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VITAL_TaxonomyEdge.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VITAL_TaxonomyEdge.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalApp.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalApp.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalAuthKey.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalAuthKey.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalOrganization.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalOrganization.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalProvisioning.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalProvisioning.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalSegment.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalSegment.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceAdminKey.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceAdminKey.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceAllegrographConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceAllegrographConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceIndexedDBConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceIndexedDBConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceKey.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceKey.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceLuceneDiskConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceLuceneDiskConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceLuceneMemoryConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceLuceneMemoryConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceMockConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceMockConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServicePrimeConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServicePrimeConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceRootKey.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceRootKey.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceSaaSConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceSaaSConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceSparkConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceSparkConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalServiceSqlConfig.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalServiceSqlConfig.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalSession.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalSession.py`

 * *Files identical despite different names*

### Comparing `vital-ai-vitalsigns-0.1.6/vital_ai_vitalsigns_core/model/VitalTransaction.py` & `vital-ai-vitalsigns-0.1.7/vital_ai_vitalsigns_core/model/VitalTransaction.py`
