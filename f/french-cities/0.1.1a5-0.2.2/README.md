# Comparing `tmp/french_cities-0.1.1a5.tar.gz` & `tmp/french_cities-0.2.2.tar.gz`
...
## Comparing `french_cities-0.1.1a5.tar` & `french_cities-0.2.2.tar`
...
### Comparing `french_cities-0.1.1a5/README.fr.md` & `french_cities-0.2.2/README.fr.md`
...
### Comparing `french_cities-0.1.1a5/README.md` & `french_cities-0.2.2/README.md`
...
### Comparing `french_cities-0.1.1a5/french_cities/city_finder.py` & `french_cities-0.2.2/french_cities/city_finder.py`
...
### Comparing `french_cities-0.1.1a5/french_cities/departement_finder.py` & `french_cities-0.2.2/french_cities/departement_finder.py`
...
### Comparing `french_cities-0.1.1a5/french_cities/utils.py` & `french_cities-0.2.2/french_cities/utils.py`

 * *Files identical despite different names*

### Comparing `french_cities-0.1.1a5/french_cities/vintage.py` & `french_cities-0.2.2/french_cities/vintage.py`
...
### Comparing `french_cities-0.1.1a5/pyproject.toml` & `french_cities-0.2.2/pyproject.toml`
...
### Comparing `french_cities-0.1.1a5/PKG-INFO` & `french_cities-0.2.2/PKG-INFO`
