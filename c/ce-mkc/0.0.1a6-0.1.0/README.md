# Comparing `tmp/ce_mkc-0.0.1a6.tar.gz` & `tmp/ce_mkc-0.1.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "ce_mkc-0.0.1a6.tar", max compression
+gzip compressed data, was "ce_mkc-0.1.0.tar", max compression
```

## Comparing `ce_mkc-0.0.1a6.tar` & `ce_mkc-0.1.0.tar`

### file list

```diff
@@ -1,20 +1,4 @@
--rw-r--r--   0        0        0    15263 2024-03-20 07:03:50.879186 ce_mkc-0.0.1a6/README.md
--rw-r--r--   0        0        0       33 2024-05-07 16:45:18.845245 ce_mkc-0.0.1a6/ce_mkc/__init__.py
--rw-r--r--   0        0        0      163 2024-05-07 16:46:52.403210 ce_mkc-0.0.1a6/ce_mkc/__main__.py
--rw-r--r--   0        0        0        0 2024-05-07 16:26:36.738532 ce_mkc-0.0.1a6/ce_mkc/main/__init__.py
--rw-r--r--   0        0        0      157 2024-05-07 16:26:44.302520 ce_mkc-0.0.1a6/ce_mkc/main/__pycache__/__init__.cpython-39.pyc
--rw-r--r--   0        0        0    16159 2024-05-07 16:47:18.955523 ce_mkc-0.0.1a6/ce_mkc/main/__pycache__/ce_mkc.cpython-39.pyc
--rw-r--r--   0        0        0    24261 2024-05-07 16:47:12.012473 ce_mkc-0.0.1a6/ce_mkc/main/ce_mkc.py
--rw-r--r--   0        0        0        0 2024-05-07 15:13:57.333707 ce_mkc-0.0.1a6/ce_mkc/templates/__init__.py
--rw-r--r--   0        0        0      162 2024-05-07 16:46:14.512137 ce_mkc-0.0.1a6/ce_mkc/templates/__pycache__/__init__.cpython-39.pyc
--rw-r--r--   0        0        0      547 2024-03-20 07:03:50.886613 ce_mkc-0.0.1a6/ce_mkc/templates/akhq/akhq.template
--rw-r--r--   0        0        0     5286 2024-03-20 07:03:50.886893 ce_mkc-0.0.1a6/ce_mkc/templates/docker-compose.template
--rw-r--r--   0        0        0     4397 2024-03-20 07:03:50.887211 ce_mkc-0.0.1a6/ce_mkc/templates/docker-compose.template.reference
--rw-r--r--   0        0        0     1803 2024-03-20 07:03:50.887704 ce_mkc-0.0.1a6/ce_mkc/templates/kafka/kafka.template
--rw-r--r--   0        0        0      313 2024-03-20 07:03:50.888064 ce_mkc-0.0.1a6/ce_mkc/templates/kafka/zookeeper.template
--rw-r--r--   0        0        0     2251 2024-03-20 07:03:50.888532 ce_mkc-0.0.1a6/ce_mkc/templates/kafkaconnect/kafkaconnect.template
--rw-r--r--   0        0        0      112 2024-03-20 07:03:50.888816 ce_mkc-0.0.1a6/ce_mkc/templates/mongod/mongod.conf.template
--rw-r--r--   0        0        0      372 2024-03-20 07:03:50.889009 ce_mkc-0.0.1a6/ce_mkc/templates/mongod/mongod.template
--rw-r--r--   0        0        0      335 2024-03-20 07:03:50.889354 ce_mkc-0.0.1a6/ce_mkc/templates/schemaregistry/schemaregistry.template
--rw-r--r--   0        0        0      597 2024-05-07 16:49:46.729876 ce_mkc-0.0.1a6/pyproject.toml
--rw-r--r--   0        0        0    16090 1970-01-01 00:00:00.000000 ce_mkc-0.0.1a6/PKG-INFO
...
### Comparing `ce_mkc-0.0.1a6/README.md` & `ce_mkc-0.1.0/README.md`

 * *Files identical despite different names*

### Comparing `ce_mkc-0.0.1a6/ce_mkc/main/ce_mkc.py` & `ce_mkc-0.1.0/ce_mkc.py`
...
### Comparing `ce_mkc-0.0.1a6/pyproject.toml` & `ce_mkc-0.1.0/pyproject.toml`
...
### Comparing `ce_mkc-0.0.1a6/PKG-INFO` & `ce_mkc-0.1.0/PKG-INFO`
