# Comparing `tmp/contact_phone_local-0.0.11.tar.gz` & `tmp/contact_phone_local-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "contact_phone_local-0.0.11.tar", last modified: Tue May  7 18:43:55 2024, max compression
+gzip compressed data, was "contact_phone_local-0.0.9.tar", last modified: Tue May  7 15:33:35 2024, max compression
```

## Comparing `contact_phone_local-0.0.11.tar` & `contact_phone_local-0.0.9.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/
--rw-r--r--   0 runner    (1001) docker     (127)      711 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       44 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/contact_phone_local/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/contact_phone_local/src/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/contact_phone_local/src/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     6561 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/contact_phone_local/src/contact_phone_local.py
--rw-r--r--   0 runner    (1001) docker     (127)      902 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/contact_phone_local/src/contact_phone_local_constants.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/contact_phone_local.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      711 2024-05-07 18:43:54.000000 contact_phone_local-0.0.11/contact_phone_local.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      387 2024-05-07 18:43:54.000000 contact_phone_local-0.0.11/contact_phone_local.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-07 18:43:54.000000 contact_phone_local-0.0.11/contact_phone_local.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      135 2024-05-07 18:43:54.000000 contact_phone_local-0.0.11/contact_phone_local.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       20 2024-05-07 18:43:54.000000 contact_phone_local-0.0.11/contact_phone_local.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      319 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-07 18:43:54.998449 contact_phone_local-0.0.11/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1224 2024-05-07 18:43:30.000000 contact_phone_local-0.0.11/setup.py
...
### Comparing `contact_phone_local-0.0.11/PKG-INFO` & `contact_phone_local-0.0.9/PKG-INFO`
...
### Comparing `contact_phone_local-0.0.11/contact_phone_local/src/contact_phone_local.py` & `contact_phone_local-0.0.9/contact_phone_local/src/contact_phones_local.py`
...
### Comparing `contact_phone_local-0.0.11/contact_phone_local/src/contact_phone_local_constants.py` & `contact_phone_local-0.0.9/contact_phone_local/src/contact_phones_local_constants.py`
...
### Comparing `contact_phone_local-0.0.11/contact_phone_local.egg-info/PKG-INFO` & `contact_phone_local-0.0.9/contact_phone_local.egg-info/PKG-INFO`
...
### Comparing `contact_phone_local-0.0.11/setup.py` & `contact_phone_local-0.0.9/setup.py`
