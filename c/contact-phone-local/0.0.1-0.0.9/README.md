# Comparing `tmp/contact_phone_local-0.0.1.tar.gz` & `tmp/contact_phone_local-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "contact_phone_local-0.0.1.tar", last modified: Tue May  7 15:56:51 2024, max compression
+gzip compressed data, was "contact_phone_local-0.0.9.tar", last modified: Tue May  7 15:33:35 2024, max compression
```

## Comparing `contact_phone_local-0.0.1.tar` & `contact_phone_local-0.0.9.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 15:56:51.633642 contact_phone_local-0.0.1/
--rw-r--r--   0 runner    (1001) docker     (127)      710 2024-05-07 15:56:51.633642 contact_phone_local-0.0.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       44 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 15:56:51.629642 contact_phone_local-0.0.1/contact_phone_local/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 15:56:51.633642 contact_phone_local-0.0.1/contact_phone_local/src/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/contact_phone_local/src/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     6561 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/contact_phone_local/src/contact_phone_local.py
--rw-r--r--   0 runner    (1001) docker     (127)      902 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/contact_phone_local/src/contact_phone_local_constants.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-07 15:56:51.633642 contact_phone_local-0.0.1/contact_phone_local.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      710 2024-05-07 15:56:51.000000 contact_phone_local-0.0.1/contact_phone_local.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      387 2024-05-07 15:56:51.000000 contact_phone_local-0.0.1/contact_phone_local.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-07 15:56:51.000000 contact_phone_local-0.0.1/contact_phone_local.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      135 2024-05-07 15:56:51.000000 contact_phone_local-0.0.1/contact_phone_local.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       20 2024-05-07 15:56:51.000000 contact_phone_local-0.0.1/contact_phone_local.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      318 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-07 15:56:51.633642 contact_phone_local-0.0.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1223 2024-05-07 15:56:26.000000 contact_phone_local-0.0.1/setup.py
...
### Comparing `contact_phone_local-0.0.1/PKG-INFO` & `contact_phone_local-0.0.9/PKG-INFO`
...
### Comparing `contact_phone_local-0.0.1/contact_phone_local/src/contact_phone_local.py` & `contact_phone_local-0.0.9/contact_phone_local/src/contact_phones_local.py`
...
### Comparing `contact_phone_local-0.0.1/contact_phone_local/src/contact_phone_local_constants.py` & `contact_phone_local-0.0.9/contact_phone_local/src/contact_phones_local_constants.py`
...
### Comparing `contact_phone_local-0.0.1/contact_phone_local.egg-info/PKG-INFO` & `contact_phone_local-0.0.9/contact_phone_local.egg-info/PKG-INFO`
...
### Comparing `contact_phone_local-0.0.1/setup.py` & `contact_phone_local-0.0.9/setup.py`
