# Comparing `tmp/sz_utils-0.4.tar.gz` & `tmp/sz_utils-0.5.tar.gz`
...
## Comparing `sz_utils-0.4.tar` & `sz_utils-0.5.tar`
...
### Comparing `sz_utils-0.4/LICENSE` & `sz_utils-0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `sz_utils-0.4/PKG-INFO` & `sz_utils-0.5/PKG-INFO`
...
### Comparing `sz_utils-0.4/setup.py` & `sz_utils-0.5/setup.py`
...
### Comparing `sz_utils-0.4/sz_utils.egg-info/PKG-INFO` & `sz_utils-0.5/sz_utils.egg-info/PKG-INFO`
