# Comparing `tmp/bin_package_manager-2.2.6.tar.gz` & `tmp/bin_package_manager-2.2.7.tar.gz`
...
## Comparing `bin_package_manager-2.2.6.tar` & `bin_package_manager-2.2.7.tar`
...
### Comparing `bin_package_manager-2.2.6/README.md` & `bin_package_manager-2.2.7/README.md`
...
### Comparing `bin_package_manager-2.2.6/bpm/command.py` & `bin_package_manager-2.2.7/bpm/command.py`
...
### Comparing `bin_package_manager-2.2.6/bpm/lib/windowspathadder.py` & `bin_package_manager-2.2.7/bpm/lib/windowspathadder.py`

 * *Files identical despite different names*

### Comparing `bin_package_manager-2.2.6/bpm/storage.py` & `bin_package_manager-2.2.7/bpm/storage.py`
...
### Comparing `bin_package_manager-2.2.6/bpm/utils/constants.py` & `bin_package_manager-2.2.7/bpm/utils/constants.py`
...
### Comparing `bin_package_manager-2.2.6/pyproject.toml` & `bin_package_manager-2.2.7/pyproject.toml`
...
### Comparing `bin_package_manager-2.2.6/PKG-INFO` & `bin_package_manager-2.2.7/PKG-INFO`
