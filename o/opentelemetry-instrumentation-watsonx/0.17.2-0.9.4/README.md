# Comparing `tmp/opentelemetry_instrumentation_watsonx-0.17.2.tar.gz` & `tmp/opentelemetry_instrumentation_watsonx-0.9.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.17.2.tar", max compression
+gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.9.4.tar", max compression
```

## Comparing `opentelemetry_instrumentation_watsonx-0.17.2.tar` & `opentelemetry_instrumentation_watsonx-0.9.4.tar`

### file list

```diff
@@ -1,7 +1,5 @@
--rw-r--r--   0        0        0     1495 2024-05-07 16:03:14.085875 opentelemetry_instrumentation_watsonx-0.17.2/README.md
--rw-r--r--   0        0        0    17916 2024-05-07 16:03:14.085875 opentelemetry_instrumentation_watsonx-0.17.2/opentelemetry/instrumentation/watsonx/__init__.py
--rw-r--r--   0        0        0       42 2024-05-07 16:03:14.085875 opentelemetry_instrumentation_watsonx-0.17.2/opentelemetry/instrumentation/watsonx/config.py
--rw-r--r--   0        0        0      701 2024-05-07 16:03:14.085875 opentelemetry_instrumentation_watsonx-0.17.2/opentelemetry/instrumentation/watsonx/utils.py
--rw-r--r--   0        0        0       23 2024-05-07 16:03:14.085875 opentelemetry_instrumentation_watsonx-0.17.2/opentelemetry/instrumentation/watsonx/version.py
--rw-r--r--   0        0        0     1259 2024-05-07 16:03:42.333857 opentelemetry_instrumentation_watsonx-0.17.2/pyproject.toml
--rw-r--r--   0        0        0     2581 1970-01-01 00:00:00.000000 opentelemetry_instrumentation_watsonx-0.17.2/PKG-INFO
...
### Comparing `opentelemetry_instrumentation_watsonx-0.17.2/README.md` & `opentelemetry_instrumentation_watsonx-0.9.4/README.md`
...
### Comparing `opentelemetry_instrumentation_watsonx-0.17.2/pyproject.toml` & `opentelemetry_instrumentation_watsonx-0.9.4/pyproject.toml`
...
### Comparing `opentelemetry_instrumentation_watsonx-0.17.2/PKG-INFO` & `opentelemetry_instrumentation_watsonx-0.9.4/PKG-INFO`
