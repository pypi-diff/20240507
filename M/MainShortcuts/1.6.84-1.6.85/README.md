# Comparing `tmp/mainshortcuts-1.6.84.tar.gz` & `tmp/mainshortcuts-1.6.85.tar.gz`
...
### Comparing `mainshortcuts-1.6.84/src/MainShortcuts/__init__.py` & `mainshortcuts-1.6.85/src/MainShortcuts/__init__.py`
